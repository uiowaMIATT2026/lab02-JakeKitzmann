...
Images were created and visualized using SimpleITK (2.5.3, ITK 5.4), Numpy (Version 2.4.3), and MatPlotLib (Version 3.10.8) in a Jupyter Notebook (IPython Version 9.12.0). The python packages used were tracked and locked using a Pixi environment (Version 0.66.0).
